...
double value;
 ...
 bool PhysicalNumber::operator==(const PhysicalNumber &a){
  ...
  istream& operator>>(istream& is, PhysicalNumber& p){
    ...
    if(newUnit.compare("cm")== 0) p.u = Unit::CM;
    else if (newUnit.compare("m")== 0) p.u = Unit::M;
    else if (newUnit.compare("km")== 0) p.u = Unit::KM;
    else if (newUnit.compare("sec")== 0) p.u = Unit::SEC;
    else if (newUnit.compare("min")== 0) p.u = Unit::MIN;
    else if (newUnit.compare("hour")== 0) p.u = Unit::HOUR;
    else if (newUnit.compare("g")== 0) p.u = Unit::G;
    else if (newUnit.compare("kg")== 0) p.u = Unit::KG;
    else if (newUnit.compare("ton")== 0) p.u = Unit::TON;
